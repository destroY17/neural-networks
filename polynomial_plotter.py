...
def plot_polynomial(x_values, y_values, degree, name, color, isPlotPoints=False):
    """
    ...
    :param isPlotPoints: указывает, нужна ли отрисовка точек вразброс
    :return:
    """
    ...
    if isPlotPoints:
        plt.scatter(x_values, y_values, color=f'{color}', label=f'{name} points')
